...
jQuery._farbtastic = function (container, callback) {
   ...
   */
  fb.setColor = function (color, callCallback) {
    var unpack = fb.unpack(color);
    if (fb.color != color && unpack) {
      fb.color = color;
      fb.rgb = unpack;
      fb.hsl = fb.RGBToHSL(fb.rgb);
      fb.updateDisplay(callCallback);
    }
    return this;
  }
   ...
   */
  fb.updateDisplay = function (callCallback) {
    callCallback = typeof callCallback !== 'undefined' ? callCallback : true;
    // Markers
    ...
    if (typeof fb.callback == 'object') {
      ...
      fb.callback.call(fb, fb.color, callCallback);
    }
  }
